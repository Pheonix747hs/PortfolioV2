...
const DisplacementSphere: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        time: { value: 0 },
        baseColor: { value: new THREE.Color(0xbd9f67) }, // Blue core
        tipColor: { value: new THREE.Color(0xd3d3d3) }, // White tips
        fogColor: { value: new THREE.Color(0x111111) },
        fogStart: { value: 30.0 }, // Distance where fog starts
        fogEnd: { value: 58.0 }, // Distance where fog is maximum
      },
      vertexShader: `
        uniform float time;
        ...
        void main() {
            ...
            // Displace vertex along normal with increased amplitude
