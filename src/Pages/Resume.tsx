...
export function PDFViewer({ fileId, title }: PDFViewerProps) {
  ...
  return (
    <div className="w-full max-w-4xl md:mx-auto mt-20 md:mt-0  p-4">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden ml-11 calc(h-screen - 8rem) md:h-[95vh] ">
        ...
        <div className="relative bg-gray-50">
          <iframe
            src={pdfUrl}
            className="w-full h-[500px] md:h-[95vh] overflow-y-auto"
            allow="autoplay"
            loading="lazy"
          />
          ...
          <a
            ...
            className="absolute bottom-4 right-6 flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg"
          >
